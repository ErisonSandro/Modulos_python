...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 683, 470))
        ...
        self.inputAbrirArqivo = QtWidgets.QLineEdit(self.centralwidget)
        self.inputAbrirArqivo.setObjectName("inputAbrirArqivo")
        self.gridLayout.addWidget(self.inputAbrirArqivo, 1, 0, 1, 4)
