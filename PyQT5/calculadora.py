...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora Nenê')
        ...
        self.add_btn(QPushButton('<'), 2, 4, 1, 1,
                     lambda: self.display.setText(
                         self.display.text()[:-1]
                ), 'background: #13823a; color: #fff; font-weight: 900;'
        )
        ...
        self.add_btn(QPushButton('='), 4, 4, 1, 1,
                     self.igual,
                     'background: #095680; color: #fff; font-weight: 900;'
        )

        self.setCentralWidget(self.cw)


    def add_btn(self, btn, row, col, rowspam, colspan, funcao=None, style=None):
        self.grid.addWidget(btn, row, col, rowspam, colspan)
